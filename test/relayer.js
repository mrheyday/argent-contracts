...
contract("RelayerManager", (accounts) => {
  ...
  beforeEach(async () => {
    ...
    testFeature = await TestFeature.new(lockStorage.address, versionManager.address, false, 0);
    testFeatureNew = await TestFeature.new(lockStorage.address, versionManager.address, false, 0);
